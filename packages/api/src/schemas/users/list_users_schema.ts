...
const user_item_schema = z.object({
  id: z.string(),
  hotel_id: z.string(),
...
export const list_users_response_schema = z.object({
  data: z.array(user_item_schema),
  meta: z.object({
    pagina: z.number(),
    limite: z.number(),
    total: z.number(),
...
export type ListUsersQueryInput = z.infer<typeof list_users_query_schema>
